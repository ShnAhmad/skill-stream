...
function HeroSection() {
  return (
    <div className="relative w-full mx-auto">
      ...
      <div
        className="relative w-full h-full bg-cover text-white py-24"
      ...
      >
        <div className="relative container mx-auto text-center px-4">
          ...
          <Link
            to="/logout"
            className="bg-[var(--color-primary)]  font-semibold px-6 py-3 rounded-lg shadow-md transition-all ease-in-out duration-300 hover:text-[var(--color-primary-500)]"
          >
